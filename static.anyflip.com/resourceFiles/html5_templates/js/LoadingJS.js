...
function add_css(str_css) {
  try {
    ...
    //Firefox,Opera,Safari,Chromeä¸‹å¯è¡Œ
...
// åˆ¤æ–­æ¡ä»¶: æ ¹æ®ä¸»è‰²è°ƒçš„ hsl
// hçš„åŒºé—´ï¼š[0,49],[50,190],[191,360]
// s ä¸ç”¨åˆ¤æ–­
// lçš„åŒºé—´ï¼š[0,39],[40,60],[61,100]
...
function rgbtohsl(r, g, b) {
  ...
  s = Math.round(s * 100); //è½¬æ¢æˆç™¾åˆ†æ¯”çš„å½¢å¼
  l = Math.round(l * 100);
  return [h, s, l];
}
  ...
  GuideLoadingJS.prototype = {
      ...
      $pop.insertAdjacentHTML(
        ...
        <div class="${this.POP}Contain">
          ...
          <section class="${this.POP}Qrcode" >
            <div class="${this.POP}Title">
              <svg class="svg" version="1.1" id="å›¾å±‚_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20" style="enable-background:new 0 0 20 20;" xml:space="preserve"><path class="st0" d="M19.5,4.8C19.5,4.9,19.5,4.9,19.5,4.8c0.6,0.7,0.6,1.7-0.1,2.3l-8.3,8.1c-0.6,0.6-1.7,0.6-2.3,0L0.5,7.1l0,0c-0.6-0.6-0.6-1.6,0-2.2c0.7-0.6,1.7-0.6,2.3,0l7.2,6.9l7.1-6.9C17.8,4.2,18.8,4.2,19.5,4.8L19.5,4.8z"/></svg>
            </div>
    ...
    initEvent() {
      ...
      $cover.addEventListener('click', e => {
        ...
        this.hide();
        // location.href = 'yunzhan365://com.wancai.app.yunzhan/read/?bookId=30948867&number=62178792&title=ä¸œæ–¹ç”µå½±æ‚å¿—-9æœˆåˆŠ&link=https://book.yunzhan365.com/jvfi/neku/index.html'
        location.href =
    ...
    onResize() {
      ...
      let type = this.isIOS ? '' : screen.orientation.type.split('-')[0]; // æ¨ªå±ï¼šlandscape  ç«–å±ï¼športrait
      if (this.isIOS) {
      ...
      // é¢„è§ˆæ¨¡å¼ä¸‹ä¼šè¯†åˆ«ä¸ºæ¨ªå±ï¼Œå¼ºåˆ¶å†™æ­»ä¸ºç«–å±
    ...
    bindDragEvent() {
      ...
      hammer.on('panstart panmove panend pancancel', e => {
        ...
        // è®¡ç®—æ°´å¹³å’Œåž‚ç›´æ–¹å‘ä¸Šçš„ç§»åŠ¨è·ç¦»
        var deltaX = e.deltaX;
        ...
        if (e.type === 'panend' || e.type === 'pancancel') {
          ...
          // å¦‚æžœæ°´å¹³æ–¹å‘ä¸Šçš„ç§»åŠ¨è·ç¦»å¤§äºŽ20%åƒç´ ï¼Œåˆ™éšè—
